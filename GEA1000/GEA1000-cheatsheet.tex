...
\begin{itemize}
	\item \textbf{Atomistic Fallacy}: Individual level correlation to conclude ecological (aggregate level) correlation
	\item \textbf{Ecological Fallacy}: Ecological (aggregate level) correlation to conclude individual level correlation
\end{itemize}
